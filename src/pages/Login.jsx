...
export default function Login() {
  ...
  const handleDiscordLogin = async () => {
    try {
      ...
      if (error) showToast('Discord Login Failed: ' + error.message, 'error')
    } catch {
      showToast('Network Error', 'error')
    }
  }
        ...
        <div className="relative bg-zinc-900/60 backdrop-blur-2xl border border-white/10 rounded-[32px] p-8 shadow-2xl">
          ...
          <div className="mb-6">
            <button type="button" onClick={handleDiscordLogin}
              className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-black py-4 rounded-2xl text-[11px] uppercase tracking-[0.2em] transition-all hover:shadow-[0_0_20px_rgba(88,101,242,0.4)] border border-white/10">
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <div className="relative bg-[#1a1a1a] px-4 text-[9px] font-black tracking-widest uppercase text-gray-500">OR TERMINAL LOGIN</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group relative">
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/forgot-password" className="text-[9px] text-cyan-400 hover:text-cyan-300 hover:underline transition font-bold tracking-widest uppercase">Lupa Password?</Link>
              </div>
            ...
            <button type="submit" disabled={loading}
              className="group relative w-full bg-gradient-to-r from-cyan-600 to-purple-600 text-white font-black py-4.5 rounded-2xl text-[11px] uppercase tracking-[0.2em] active-scale hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden mt-4 border border-white/10">
