...
export default function GameCard({ game }) {
  ...
  return (
    <div className="group bg-zinc-900/40 backdrop-blur-sm border border-white/[0.04] rounded-3xl overflow-hidden hover:border-purple-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-purple-600/15 hover:-translate-y-1">
      <div
