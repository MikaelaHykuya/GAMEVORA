export default function AdminUploadFiveM({ editId, form, setForm, downloadLinks, setDownloadLinks, handleZipUpload, uploadingZip, saveGame }) {
  return (
    <div className="bg-zinc-900/40 border border-white/[0.04] rounded-3xl p-6 md:p-10 max-w-3xl mx-auto">
      <h2 className="text-xl font-black uppercase tracking-tight mb-8">{editId ? `Update: ${form.title}` : 'Upload FiveM'}</h2>
